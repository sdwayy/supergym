...
var onAnchorClick = function onAnchorClick(anchor) {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("html, body").animate({
    scrollTop: jquery__WEBPACK_IMPORTED_MODULE_0___default()(block).offset().top + "px"
  });
};

if (promoBtn) {
  var onPromoBtnClick = function onPromoBtnClick() {
...
if (subscriptionsListItems.length > 0) {
  var _iterator = _createForOfIteratorHelper(subscriptionsListItems),
      _step;

  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var subscriptionsItems = _step.value;
      var priceBlock = subscriptionsItems.querySelector("span:last-of-type");
...
if (trainers) {
  ...
  var trainersSwiper = new swiper__WEBPACK_IMPORTED_MODULE_1__["default"](".trainers__list-container", {
    // Optional parameters
    loop: true,
...
if (trainersCards.length > 0) {
  var _iterator2 = _createForOfIteratorHelper(trainersCards),
      _step2;

  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      var trainerCard = _step2.value;
...
if (phoneInput) {
  var validatePhone = new imask__WEBPACK_IMPORTED_MODULE_2__["default"](phoneInput, {
